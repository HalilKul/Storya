...
import { getBooksByCategory, getCategoryById, getImagePath } from '@/lib/utils';
import Header from '@/components/Header';
import Footer from '@/components/Footer';
import BookCard from '@/components/BookCard';
import { Book } from '@/lib/types';

// TypeScript hatası burada çözülüyor - Props tipi tanımlanıyor
type Props = {
  params: {
    slug: string
  }
    ...
    <>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl shadow-md p-6 mb-8">
          ...
          <p className="text-gray-600">{category.description || `${category.name} kategorisindeki tüm kitaplar`}</p>
        </div>
