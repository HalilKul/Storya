...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Demo kullanıcı kontrolleri (gerçek bir uygulamada burada API çağrısı olacak)
          ...
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-8">
              ...
              <div className="mt-6 flex items-center justify-center">
                ...
                <Link href="/kayit" className="ml-1 text-sm font-medium text-primary-600 hover:text-primary-700">
                  Hemen Kayıt Olun
                </Link>
              </div>
